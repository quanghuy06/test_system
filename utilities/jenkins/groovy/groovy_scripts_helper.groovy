...
/**
* Name of groovy script which has methods to synchronize test cases folder on test nodes to update
* new reference data in Post Integration
*/
def SynchronizeTestCasesFolderOnNodesScriptName() {
    return "synchronize_test_cases_on_nodes.groovy"
}

/**
* Relative path to groovy script which has methods to synchronize test cases folder on test nodes to
* update new reference data in Post Integration
*/
def SynchronizeTestCasesFolderOnNodesScriptR() {
    return "${GroovyLibR()}/${SynchronizeTestCasesFolderOnNodesScriptName()}"
}

/**
* Get full path to groovy script which has methods to synchronize test cases folder on test nodes to
* update new reference data in Post Integration base on path to Mekong directory passed.
*/
def SynchronizeTestCasesFolderOnNodesScriptPath(String mekong) {
    return "${mekong}/${SynchronizeTestCasesFolderOnNodesScriptR()}"
}
