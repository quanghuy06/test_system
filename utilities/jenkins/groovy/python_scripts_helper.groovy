...
/**
* Name of python script which help synchronizing test cases folder on test nodes of test system to
* update new reference data in Post Integration
*/
def SynchronizeTestCasesFolderOnNodeScriptName() {
    return "synchronize_test_cases_on_nodes.py"
}

/**
* Relative path to python script which help synchronizing test cases folder on test nodes of test
* system to update new reference data in Post Integration
*/
def SynchronizeTestCasesFolderOnNodeScriptR() {
    return "${PythonLibR()}/${SynchronizeTestCasesFolderOnNodeScriptName()}"
}

/**
* Get full path to python script which help synchronizing test cases folder on test nodes of test
* system to update new reference data in Post Integration base on path to mekong directory passed
*/
def SynchronizeTestCasesFolderOnNodeScriptPath(String mekong) {
    return "${mekong}/${SynchronizeTestCasesFolderOnNodeScriptR()}"
}
