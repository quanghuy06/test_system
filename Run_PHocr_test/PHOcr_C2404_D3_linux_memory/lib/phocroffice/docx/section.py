...
class Section(object):
    ...
    @property
    def cols(self):
        return self._sectPr.col_space

    @cols.setter
    def cols(self, value):
        self._sectPr.col_space = value
    ...
    def page_size(self):
        """
        The standard page size returned by code (w:code). Refer to ...py to
        understand more.
        :return:
        """
        return self._sectPr.page_size

    @page_size.setter
    def page_size(self, value):
        self._sectPr.page_size = value
