...
class Font(ElementProxy):
    ...
    def east_asia(self):
        """
        Get or set the eatasia attributes in w:eastAsia tag in w:rPr
        """
        rPr = self._element.rPr
        if rPr is None:
            return None
    ...
    def theme(self):
        """
        Get or set the theme name for this |Font| instance, causing the
        text it controls to appear in the named font, if a matching font is
        found. |None| indicates the typeface is inherited from the style
        hierarchy.
        """
    ...
    def theme(self, value):
        ...
        rPr.rFonts_eastAsiaTheme = value
    ...
    def hint(self, value):
        rPr = self._element.get_or_add_rPr()
        rPr.rFonts_hint = value

    @property
    def lang(self):
        """
        Get or set the language for this |Font| instance
        """
        rPr = self._element.rPr
        if rPr is None:
            return None
        return rPr.lang_eastAsia

    @lang.setter
    def lang(self, value):
        rPr = self._element.get_or_add_rPr()
        rPr.lang_eastAsia = value
