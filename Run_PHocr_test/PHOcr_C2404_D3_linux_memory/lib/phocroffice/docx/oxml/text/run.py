...
class CT_R(BaseOxmlElement):
    ...
    lastRenderedPageBreak = ZeroOrOne('w:lastRenderedPageBreak')
    ...
    def add_lastRenderedPageBreak(self):
        """
        Return a newly added ``<w:lastRenderedPageBreak>`` element.
        """
        lastRenderedPageBreak = self._add_lastRenderedPageBreak()
...
class CT_LastRenderedPageBreak(BaseOxmlElement):
    """
    ``<w:lastRenderedPageBreak>`` element
    This element indicates that there was a page break resulting
    from pagination of this content
    """
