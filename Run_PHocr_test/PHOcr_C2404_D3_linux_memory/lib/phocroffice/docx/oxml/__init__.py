...
oxml_parser = etree.XMLParser(remove_blank_text=True, resolve_entities=False, ns_clean=True, recover=True, encoding='utf-8')
...
from .numbering import (
    CT_Num, CT_Numbering, CT_NumLvlOverride, CT_NumPr, CT_NumLvl
)
register_element_cls('w:abstractNumId', CT_DecimalNumber)
register_element_cls('w:ilvl',          CT_DecimalNumber)
register_element_cls('w:lvl',           CT_NumLvl)
register_element_cls('w:lvlOverride',   CT_NumLvlOverride)
...
from .section import CT_DocGrid, CT_TextDirection, CT_Cols, CT_PageMar, CT_PageSz, CT_SectPr, CT_SectType
...
from .shape import (
    ...
    CT_GraphicalObjectData, CT_Inline, CT_Anchor, CT_NonVisualDrawingProps, CT_Picture,
    CT_PictureNonVisual, CT_Point2D, CT_PositiveSize2D, CT_ShapeProperties,
    CT_Transform2D
)
register_element_cls('wps:wsp',       CT_Textbox)
...
from .table import (
    ...
    CT_TblCellMar, CT_TblPr, CT_TblCellBoundingPosition,
...
register_element_cls('w:top',        CT_TblCellBoundingPosition)
register_element_cls('w:left',       CT_TblCellBoundingPosition)
register_element_cls('w:bottom',     CT_TblCellBoundingPosition)
register_element_cls('w:right',      CT_TblCellBoundingPosition)
...
from .text.font import (
    CT_Color, CT_Fonts, CT_Lang, CT_Highlight, CT_HpsMeasure, CT_RPr, CT_Underline,
    CT_VerticalAlignRun
)
...
register_element_cls('w:lang',       CT_Lang)
...
from .text.parfmt import (
    CT_Ind, CT_ShadingBackgroundColor, CT_Jc, CT_PPr, CT_Spacing, CT_TabStop, CT_TabStops
)
register_element_cls('w:ind',             CT_Ind)
register_element_cls('w:shd',             CT_ShadingBackgroundColor)
...
register_element_cls('w:contextualSpacing',    CT_DecimalNumber)

from .text.run import CT_Br, CT_R, CT_Text, CT_LastRenderedPageBreak
