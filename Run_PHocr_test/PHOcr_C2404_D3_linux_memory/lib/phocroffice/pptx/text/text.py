...
from ..enum.dml import MSO_FILL_TYPE as MSO_FILL
from ..enum.lang import MSO_LANGUAGE_ID
from ..enum.text import MSO_AUTO_SIZE, MSO_TEXT_UNDERLINE_TYPE as MSO_UNDERLINE
...
from phocr_shared.shared import Centipoints, Emu, lazyproperty, Pt
...
class TextFrame(Subshape):
    ...
    def text_direction(self):
        """
        Read/write member of :ref:`MsoTextDirection` enumeration or |None|,
        representing the direction of text in this text frame.
    ...
    def word_vert(self):
        """
        Read-write setting determining the type of text direction that has been
        applied. Valid values are horizontal, vertical, rot90, rot270, stacked.
        """
        return self._txBody.bodyPr.vert

    @word_vert.setter
    def word_vert(self, value):
...
class _Paragraph(Subshape):
    ...
    def add_break(self):
        """
        Add break line to this paragraph.
        """
        br = self._p.add_br()
    ...
    def first_line_indent(self):
        """
        Read-write integer indentation value for first line of this paragraph.
        """
        return self._pPr.first_line_indent

    @first_line_indent.setter
    def first_line_indent(self, first_line_indent):
        self._pPr.first_line_indent = first_line_indent

    @property
    def left_margin(self):
        """
        Add left margin of one paragraph
        """
        return self._pPr.left_margin

    @left_margin.setter
    def left_margin(self, left_margin):
        self._pPr.left_margin = left_margin

    @property
    def right_margin(self):
        """
        Add right margin of one paragraph
        """
        return self._pPr.right_margin

    @right_margin.setter
    def right_margin(self, right_margin):
        self._pPr.right_margin = right_margin
    ...
    def bullet_font(self):
        ...
        if pPr is None:
            return None
        return pPr.bullet_font

    @bullet_font.setter
    def bullet_font(self, value):
        pPr = self._p.get_or_add_pPr()
        pPr.bullet_font = value
