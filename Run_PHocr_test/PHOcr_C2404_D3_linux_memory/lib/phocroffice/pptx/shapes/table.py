...
class _Cell(Subshape):
    ...
    def horizontal_anchor(self):
        """
        Horizontal anchor of this table cell, determines the horizontal alignment
        of text in the cell.
        """
        return self._tc.anchorCtr

    @horizontal_anchor.setter
    def horizontal_anchor(self, boolean_value):
        """
        Set horizontal_anchor of this cell to *horizontal_anchor*.
        """
        self._tc.anchorCtr = boolean_value
