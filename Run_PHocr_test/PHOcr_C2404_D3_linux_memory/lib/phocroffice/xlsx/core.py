...
class Core(xmlwriter.XMLwriter):
    ...
    def _assemble_xml_file(self):
        ...
        # These 2 functions below is commented because it'll change date, time
        # created and modified time by time when running XlsxWriter module
        # To enable this function for any further purpose, feel free to uncomment
        # these line!
