...
class TestBBErrorTypeReporter(unittest.TestCase):
    def test_report_normally(self):
        ...
        # Initial reporter
        reporter = BbErrorTypesReporter(test_file=test_file, compare_file=compare_file,
                                        test_folder=test_folder)

        # Do report
        reporter.do_work()

        output_file_name = "BoundingBoxErrorTypes.tsv"
