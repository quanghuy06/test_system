...
*              This script is used to configure for PHOcr-Delete-Old-Results on Jenkins server of
*              mini-system of Mekong Testing.
*/
...
stage("Checkout Mekong utilities") {
    node("master") {
        ...
        if ("${JenkinsFileSystemConfigurationCherryPick}" != "") {
            cmd += "&& ${JenkinsFileSystemConfigurationCherryPick}"
        } else {
