...
*/
def VoteGerrit(String mekong, String change_number, String patch_set, String label,
    ...
    cmd = "ssh -p 29418 ${account}@${server} gerrit review ${change_number},${patch_set}"
    cmd += " --label ${label}=${result} -m \\\"[${label}] ${message}."
    cmd += "\nPlease check in ${build_url} for more detail!\\\""
