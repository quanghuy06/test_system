...
from phocr_shared.shared import ElementProxy, Emu, Length
...
class Document(ElementProxy):
    ...
    def add_photo(self, photo):
        """
        Return a new text box shape added in its own photo at the certain position of
        the document.
        """
        inline = self._part.new_photo_anchor(photo)
        self._element.body.add_drawing(inline)

    def add_textbox(self, textbox):
        """
        Return a new text box shape added in its own paragraph at the certain position of
        the document.
        """
        inline = self._part.new_textbox_anchor(textbox)
        self._element.body.add_drawing(inline)
    ...
    def add_updated_table(self, tbl):
        """
        Add a table having row and column counts of *rows* and *cols*
        at position *cx* and *cy* (support for setting width for each column)
        ...
        """
        table = self._body.add_updated_table(tbl)
        table.style = tbl.style
        return table

    def add_updated_table_with_table_paras(self, tbl):
        """
        Add a table having row and column counts of *rows* and *cols*
        at position *cx* and *cy* (support for setting width for each column)
        respectively and table style of *style*. *style* may be a paragraph
        ...
        table inherits the default table style of the document.
        """
        table = self._body.add_updated_table_with_table_paras(tbl)
        table.style = tbl.style
        return table
    ...
    def numberings(self):
        """
        A |Numberings| object providing access to the numberings
        in this document.
        """
