...
from phocr_shared.shared import ParentedElementProxy, lazyproperty
...
class SlideShapes(_BaseShapes):
    ...
    def add_table(self, rows, cols, left, top, width, height, tableStyleId):
        """
    ...
    def add_textbox(self, left, top, width, height, background_color=None):
        """
        Add text box shape of specified size at specified position on slide.
        """
        sp = self._add_textbox_sp(left, top, width, height, background_color)
    ...
    def _add_graphicFrame_containing_table(self, rows, cols, x, y, cx, cy, tableStyleId):
        """
    ...
    def _add_textbox_sp(self, x, y, cx, cy, background_color=None):
        """
        ...
        sp = self._spTree.add_textbox(id_, name, x, y, cx, cy, background_color)
        return sp
