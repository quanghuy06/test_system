...
from phocr_shared.shared import Centipoints, Emu
...
class ST_TextDirectionType(XsdTokenEnumeration):
    """
    Valid values for <a:bodyPr vert=""> attribute
    """
    HORZ = 'horz'            # Default
    VERT = 'vert'            # Rotate all text 90 degrees
    EAVERT = 'eaVert'        # Vertical textbox with Japanese, Chinese
    VERT270 = 'vert270'      # Rotate all text 270 degrees
    STACKED = 'wordArtVert'  # Stacked

    _members = (HORZ, VERT, EAVERT, VERT270, STACKED)
