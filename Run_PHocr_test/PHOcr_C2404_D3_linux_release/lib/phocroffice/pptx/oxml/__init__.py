...
from .text import (  # noqa: E402
    ...
    CT_TextNoBullet, CT_TextBulletFont, CT_TextNumBullet, CT_TextCharBullet,
    CT_TabList, CT_Tab
)
...
register_element_cls('a:tabLst',      CT_TabList)
register_element_cls('a:tab',         CT_Tab)
...
register_element_cls('a:buAutoNum',   CT_TextNumBullet)
