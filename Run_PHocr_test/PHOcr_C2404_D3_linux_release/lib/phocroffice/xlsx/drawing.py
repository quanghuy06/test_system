...
class Drawing(xmlwriter.XMLwriter):
    ...
    def _write_c_nv_pr(self, index, name, options=None):
        ...
        # This code below is commented because this change the descr of the photo
        # time by time
        # If you want to use this attribute, feel free to uncomment it
        # descr = options.get('description', None)

        # Set the descr to None to report unchage when run XlsxWriter time by time
        descr = None
